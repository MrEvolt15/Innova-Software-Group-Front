...
<template>
    <nav class="navbar" :class="{ collapsed: !isSidebarExpanded }">
...
.option_menu .representative_ico {
    grid-column: 1;
    grid-row: 1;
    display: flex;
    align-items: center;
...
.submenu-leave-active {
    transition: max-height 0.25s ease, opacity 0.2s ease, transform 0.2s ease, margin-top 0.25s ease;
    overflow: hidden;
}
